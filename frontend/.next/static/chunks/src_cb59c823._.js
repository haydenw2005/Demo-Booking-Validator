(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_cb59c823._.js", {
...
;
;
function TestResultsDisplay({ results }) {
    console.log(results);
...
_c3 = StatusIcon;
var _c, _c1, _c2, _c3;
__turbopack_context__.k.register(_c, "TestResultsDisplay");
__turbopack_context__.k.register(_c1, "StepItem");
__turbopack_context__.k.register(_c2, "SubtaskItem");
__turbopack_context__.k.register(_c3, "StatusIcon");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
function Home() {
    ...
    const [testProfile, setTestProfile] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        ...
        description: "this is a test profile for my AI agent demo booking test agent-- sorry if this works."
    });
    // Default goals
    ...
    const handleSubmit = async (e)=>{
        ...
        if (updatedGoals.length >= 2) {
            updatedGoals[1] = `Fill out any required forms with the following profile. Not all fields have have to be used or exist SO MOVE ON IF YOU CAN'T FIND THE FIELD, etc. Also, the order does not correpsond to the order of the site's flow. ${JSON.stringify(testProfile)}`;
        }
        try {
...
_s(Home, "BoA9BFY3HR4z10rNJP7Xdo8ne3Q=");
_c = Home;
var _c;
...
//# sourceMappingURL=src_cb59c823._.js.map